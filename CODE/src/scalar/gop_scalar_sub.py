...
def calculate_denominator(probabilities, canonical_transcription, target_phoneme):
    ...
    if not remaining_phonemes:
        return total_probability  # Skip if no remaining phonemes are available

    substitute_phoneme = remaining_phonemes[0]  # Use the first remaining phoneme
